...
#code from http://hannahfry.co.uk/

#Functions to convert latitude and longitude to GB OS easting and northings and back again
...
#converts OS easting northing to lat lon
...
#http://hannahfry.co.uk/2012/02/01/converting-latitude-and-longitude-to-british-national-grid/
#converts lat lon to easting northing
...
if __name__ == "__main__":
    print(OSGB36toWGS84(543500,164600))
    print(WGS84toOSGB36(51.362346934514925, 0.05979043512069447))
